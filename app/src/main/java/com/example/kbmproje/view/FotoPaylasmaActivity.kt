...
import kotlinx.android.synthetic.main.activity_foto_paylasma.*
import java.util.*

class FotoPaylasmaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_foto_paylasma)
